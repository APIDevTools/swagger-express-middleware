...
describe('JSON Schema - parse date-time params', function() {
  ...
  it('should parse a valid date-time param',
    function(done) {
      ...
      var express = helper.integrationTest(schema, '2010-12-31T23:59:59.999Z', done);
  ...
  it('should throw an error if the value is not a valid date-time',
    function(done) {
      ...
      var express = helper.integrationTest(schema, '2000-11-16T25:75:23Z', done);
  ...
  it('should throw an error if the value is a date',
    function(done) {
      ...
      var express = helper.integrationTest(schema, '2015-05-05', done);
  ...
  it('should throw an error if the value fails schema validation',
    function(done) {
      ...
      var express = helper.integrationTest(schema, '2014-10-15T14:22:59.123-05:00', done);
  ...
  it('should throw an error if the value is above the maximum',
    function(done) {
      ...
      var express = helper.integrationTest(schema, '2009-08-12T00:00:00.001Z', done);
  ...
  it('should NOT throw an error if the value is equal to the maximum',
    function(done) {
      ...
      var express = helper.integrationTest(schema, '2009-08-12T00:00:00.000Z', done);
  ...
  it('should throw an error if the value is equal the exclusive maximum',
    function(done) {
      ...
      var express = helper.integrationTest(schema, '2009-08-12T20:00:00-08:30', done);
  ...
  it('should throw an error if the maximum is not valid',
    function(done) {
      ...
      var express = helper.integrationTest(schema, '2009-12-27T19:20:06Z', done);
  ...
  it('should throw an error if the value is below the minimum',
    function(done) {
      ...
      var express = helper.integrationTest(schema, '2009-08-11T23:59:59.999Z', done);
  ...
  it('should throw an error if the minimum is not valid',
    function(done) {
      ...
      var express = helper.integrationTest(schema, '2009-11-27T19:05:08Z', done);
