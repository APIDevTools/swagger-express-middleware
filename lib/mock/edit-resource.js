...
function mergeResource(req, res, next, dataStore) {
    ...
    dataStore.saveResource(resource, sendResponse(req, res, next, dataStore));
}
...
function overwriteResource(req, res, next, dataStore) {
    ...
    dataStore.deleteResource(resource, function(err) {
        if (err) {
            next(err);
        }
        else {
...
function deleteResource(req, res, next, dataStore) { // jshint ignore:line
    ...
    // Delete the resource
    dataStore.deleteResource(resource, function(err, deletedResource) {
