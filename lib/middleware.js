...
const requestBodyParser = require("./request-body-parser");
const paramParser = require("./param-parser");
const pathParamParser = require("./path-param-parser");
...
function Middleware (sharedRouter) {
  ...
  this.parseRequest = function (router, options) {
    ...
    return [
      ...requestBodyParser(options),
      ...paramParser(options),
      ...pathParamParser(context, router)
    ];
  };
