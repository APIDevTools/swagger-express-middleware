...
/**
 * Overrides {@link DataStore#__openResourceStore} to return data from a JSON file.
 * @protected
 */
FileDataStore.prototype.__openResourceStore = function(collection, name, callback) {
...
/**
 * Overrides {@link DataStore#__updateResourceStore} to store data in a a JSON file.
 * @protected
 */
FileDataStore.prototype.__updateResourceStore = function(collection, name, resources, callback) {
    var self = this;
