...
function swaggerParamsMetadata(req, res, next) {
    ...
    if (req.swagger.path && req.swagger.path.parameters) {
        pathParams = req.swagger.path.parameters;
    }
    if (req.swagger.operation && req.swagger.operation.parameters) {
        operationParams = req.swagger.operation.parameters;
    }

    // Combine the path and operation parameters,
    // with the operation params taking precedence over the path params
    req.swagger.params = _.unique(operationParams.concat(pathParams), function(param) {
