...
function parseFile (schema, value, propPath) {
  ...
  parsedValue.extension = path.extname(parsedValue.originalname).slice(1);
  parsedValue.name = parsedValue.filename;
  parsedValue.buffer = null;
  parsedValue.truncated = false;
