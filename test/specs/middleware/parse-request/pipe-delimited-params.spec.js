...
describe("Parse Request middleware - pipeDelimited params", () => {
  let api;

  beforeEach(() => {
    // Make all parameters pipeDelimited
  ...
  it("should not parse pipeDelimited params if the metadata middleware is not used", (done) => {
  ...
  it("should parse pipeDelimited params", (done) => {
    createMiddleware(api, (err, middleware) => {
  ...
  it("should parse pipeDelimited params of all types", (done) => {
    api.paths["/pets"].get.parameters = [
      { name: "Integer", in: "query", style: "pipeDelimited", schema: { type: "integer" }},
      { name: "Number", in: "query", style: "pipeDelimited", schema: { type: "number" }},
      { name: "BooleanTrue", in: "query", style: "pipeDelimited", schema: { type: "boolean" }},
      { name: "BooleanFalse", in: "query", style: "pipeDelimited", schema: { type: "boolean" }},
      { name: "String", in: "query", style: "pipeDelimited", schema: { type: "string" }},
      { name: "Bytes", in: "query", style: "pipeDelimited", schema: { type: "string", format: "byte" }},
      { name: "Binary", in: "query", style: "pipeDelimited", schema: { type: "string", format: "binary" }},
      { name: "Date", in: "query", style: "pipeDelimited", schema: { type: "string", format: "date" }},
      { name: "DateTime", in: "query", style: "pipeDelimited", schema: { type: "string", format: "date-time" }},
      { name: "Password", in: "query", style: "pipeDelimited", schema: { type: "string", format: "password" }},
      { name: "Array", in: "query", style: "pipeDelimited", schema: { type: "array", items: { type: "string" }}},
      { name: "Object", in: "query", style: "pipeDelimited", schema: { type: "object" }},
    ];
  ...
  it("should parse pipeDelimited params with special characters", (done) => {
    createMiddleware(api, (err, middleware) => {
      let express = helper.express(middleware.metadata(), middleware.parseRequest());
  ...
  it("should parse exploded pipeDelimited params", (done) => {
  ...
  it("should set pipeDelimited params to undefined if unspecified", (done) => {
    createMiddleware(api, (err, middleware) => {
      let express = helper.express(middleware.metadata(), middleware.parseRequest());
  ...
  it("should set pipeDelimited params to undefined if empty", (done) => {
    createMiddleware(api, (err, middleware) => {
      let express = helper.express(middleware.metadata(), middleware.parseRequest());
  ...
  it("should set pipeDelimited params to their defaults if unspecified or empty", (done) => {
